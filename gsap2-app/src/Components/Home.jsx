...
export default function Home() {
  ...
  useEffect(() => {
    ...
    tl.to(headRef.current, { color: "#1e3a8a" }, "swap+=0.3");
  ...
  return (
    <Element name="home">
    <>
        <section ref={sectionRef} className="relative flex justify-center items-center min-h-screen pt-[100px] overflow-hidden">
          {/* HEADING */}
          <h1
            ref={headRef}
